...
class GameScene10: SKScene, SKPhysicsContactDelegate {
    ...
    class func newGameScene() -> GameScene10 {
        guard let scene = SKScene(fileNamed: "GameScene10") as? GameScene10 else {
            print("Failed to load GameScene10.sks")
            abort()
        }
    ...
    override func didMove(to view: SKView) {
        ...
        let backgroundImage = SKSpriteNode(imageNamed: "backgroundSky10")
        ...
        let forground0 = SKSpriteNode(imageNamed: "forground10")
        forground0.anchorPoint = CGPointMake(0.5, 0.5)
        forground0.size = CGSize(width: 7000, height: self.frame.height-100)
        forground0.position =  CGPoint(x: 3500, y: self.frame.midY-50)
        ...
        _ = Timer.scheduledTimer(withTimeInterval: 7.0, repeats: true) { time4 in
            self.create3()
        }
    }
    ...
    func create1(){
        let create1 = SKSpriteNode(imageNamed: "objectBalloon1")
        create1.setScale(1.3)
        create1.zPosition = 4
        ...
        create1.position = CGPoint(x: 844, y: Int.random(in: 150..<350))
    ...
    func create2(){
        let create2 = SKSpriteNode(imageNamed: "objectBalloon2")
        create2.setScale(1.3)
        create2.zPosition = 4
        ...
        create2.position = CGPoint(x: 844, y: Int.random(in: 50..<350))
    ...
    func create3(){
        let create3 = SKSpriteNode(imageNamed: "objectBalloon3")
        create3.setScale(1.3)
        create3.zPosition = 4
        ...
        create3.position = CGPoint(x: 844, y: Int.random(in: 100..<370))
