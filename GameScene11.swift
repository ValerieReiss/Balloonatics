...
class GameScene11: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        let backgroundImage = SKSpriteNode(imageNamed: "backgroundSky11-0")
        ...
        let forground0 = SKSpriteNode(imageNamed: "forground11")
        ...
        _ = Timer.scheduledTimer(withTimeInterval: 7.5, repeats: true) { time4 in
            self.create3()
        }
    }
    ...
    func create1(){
        let create1 = SKSpriteNode(imageNamed: "objectBird6")
        create1.setScale(1)
        create1.zPosition = 4
        ...
        create1.position = CGPoint(x: 844, y: Int.random(in: 50..<300))
    ...
    func create2(){
        let create2 = SKSpriteNode(imageNamed: "objectBird7")
        create2.setScale(1)
        create2.zPosition = 4
        ...
        create2.position = CGPoint(x: 844, y: Int.random(in: 50..<300))
    ...
    func create3(){
        let create3 = SKSpriteNode(imageNamed: "objectCloud8")
        ...
        create3.position = CGPoint(x: 844, y: Int.random(in: 240..<370))
