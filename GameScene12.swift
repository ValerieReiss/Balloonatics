...
class GameScene12: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        let forground0 = SKSpriteNode(imageNamed: "forground12-ganz")
        forground0.anchorPoint = CGPointMake(0.5, 0.5)
        forground0.size = CGSize(width: 10000, height: self.size.height)
        forground0.position =  CGPoint(x: 5000, y: self.frame.midY)
        ...
        _ = Timer.scheduledTimer(withTimeInterval: 6.0, repeats: true) { timer4 in
            self.create3()
        }
    }
    ...
    func create1(){
        let create1 = SKSpriteNode(imageNamed: "objectPlane1")
        create1.setScale(1)
        create1.zPosition = 4
        ...
        create1.position = CGPoint(x: 844, y: Int.random(in: 200..<350))
    ...
    func create2(){
        let create2 = SKSpriteNode(imageNamed: "objectPlane2")
        create2.setScale(1)
        create2.zPosition = 4
        ...
        create2.position = CGPoint(x: 844, y: Int.random(in: 200..<350))
    ...
    func create3(){
        let create3 = SKSpriteNode(imageNamed: "objectBird1")
        ...
        create3.position = CGPoint(x: 844, y: Int.random(in: 50..<370))
    ...
    func won() {
        ...
        let jo = SKSpriteNode(imageNamed: "JO0.png")
        jo.name = "returnToMenu"
        jo.setScale(1)
        jo.zPosition = 10
        jo.position = CGPoint(x: CGRectGetMidX(self.frame), y: CGRectGetMidY(self.frame))
