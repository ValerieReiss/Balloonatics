...
class GameScene3: SKScene, SKPhysicsContactDelegate {
    ...
    class func newGameScene() -> GameScene3 {
        guard let scene = SKScene(fileNamed: "GameScene3") as? GameScene3 else {
            print("Failed to load GameScene3.sks")
            abort()
        }
    ...
    override func didMove(to view: SKView) {
        ...
        let backgroundImage = SKSpriteNode(imageNamed: "backgroundSky3")
    ...
    func create1(){
        let create1 = SKSpriteNode(imageNamed: "objectCloud4")
        create1.setScale(1)
        create1.zPosition = 4
    ...
    func create2(){
        let create2 = SKSpriteNode(imageNamed: "objectCloud6")
        create2.setScale(1)
        create2.zPosition = 4
