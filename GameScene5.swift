...
*/
class GameScene5: SKScene, SKPhysicsContactDelegate {
    
    private var magicStick : SKEmitterNode?
    
    class func newGameScene() -> GameScene5 {
        guard let scene = SKScene(fileNamed: "GameScene5") as? GameScene5 else {
            print("Failed to load GameScene5.sks")
            abort()
        }
    ...
    override func didMove(to view: SKView) {
        ...
        let moveleft1 = SKAction.moveTo(x: -7000, duration: 800)
        //let sequence1 = SKAction.sequence([moveleft1, .removeFromParent()])
        
        let forground0 = SKSpriteNode(imageNamed: "forground5")
    ...
    func create1(){
        let create1 = SKSpriteNode(imageNamed: "objectBird4")
        create1.setScale(1)
        create1.zPosition = 4
        ...
        create1.position = CGPoint(x: 844, y: Int.random(in: 50..<350))
    ...
    func create2(){
        let create2 = SKSpriteNode(imageNamed: "objectBird5")
        create2.setScale(1)
        create2.zPosition = 4
    ...
    func create3(){
        let create3 = SKSpriteNode(imageNamed: "objectCloud7")
        ...
        create3.position = CGPoint(x: 844, y: Int.random(in: 20..<360))
