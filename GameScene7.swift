...
class GameScene7: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        let forground0 = SKSpriteNode(imageNamed: "forground7")
    ...
    func create1(){
        let create1 = SKSpriteNode(imageNamed: "objectLeave1")
        create1.setScale(1)
        create1.zPosition = 4
        ...
        create1.position = CGPoint(x: 844, y: Int.random(in: 50..<150))
        
        let path = UIBezierPath()
        path.move(to: .zero)
        path.addCurve(to: CGPoint(x: -850, y: 0), controlPoint1: CGPoint(x: -150,y: 160), controlPoint2: CGPoint(x: -600, y: -160))
    ...
    func create2(){
        let create2 = SKSpriteNode(imageNamed: "objectLeave2")
        create2.setScale(1)
        create2.zPosition = 4
        ...
        create2.position = CGPoint(x: 844, y: 200)
        
        let path = UIBezierPath()
        path.move(to: .zero)
        path.addCurve(to: CGPoint(x: -850, y: 0), controlPoint1: CGPoint(x: -150,y: 100), controlPoint2: CGPoint(x: -600, y: -100))
    ...
    func create3(){
        let create3 = SKSpriteNode(imageNamed: "objectLeave3")
        ...
        create3.position = CGPoint(x: 844, y: Int.random(in: 20..<370))
        
        let path = UIBezierPath()
        path.move(to: .zero)
        path.addCurve(to: CGPoint(x: -850, y: 0), controlPoint1: CGPoint(x: -150,y: -150), controlPoint2: CGPoint(x: -600, y: +150))
