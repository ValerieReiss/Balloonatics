...
class GameScene9: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        let backgroundImage = SKSpriteNode(imageNamed: "backgroundSky9-0")
        backgroundImage.anchorPoint = CGPointMake(0.5, 0.5)
        backgroundImage.size = CGSize(width: self.size.width, height: self.size.height+100)
        ...
        let forground0 = SKSpriteNode(imageNamed: "forground9")
        forground0.anchorPoint = CGPointMake(0.5, 0.5)
        forground0.size = CGSize(width: 9000, height: self.frame.height)
        forground0.position =  CGPoint(x: 4500, y: self.frame.midY)
    ...
    func create1(){
        let create1 = SKSpriteNode(imageNamed: "objectCloud7")
        create1.setScale(1)
        create1.zPosition = 4
        ...
        create1.position = CGPoint(x: 844, y: Int.random(in: 100..<350))
    ...
    func create2(){
        let create2 = SKSpriteNode(imageNamed: "objectBird4")
        create2.setScale(1)
        create2.zPosition = 4
    ...
    func create3(){
        let create3 = SKSpriteNode(imageNamed: "objectPlane1")
        ...
        create3.position = CGPoint(x: 844, y: Int.random(in: 200..<350))
